  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-xl overflow-hidden grid md:grid-cols-2">
        <div className="hidden md:block relative bg-gradient-to-br from-pink-600 to-purple-700 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <Image src="/1.png" alt="MamaCare Mother and Child" width={520} height={620} className="object-contain drop-shadow-2xl" priority />
          </div>
        </div>
          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="text-center mt-8">
                <Link href="/login" className="text-pink-600 font-medium hover:underline flex items-center justify-center gap-2" >
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mt-3"> We&apos;ve sent a password reset link to<br /> <strong>{email}</strong> </p>
              <Button variant="outline" className="mt-8" onClick={() => setIsSubmitted(false)} > Send Again </Button>
              <div className="mt-6">
                <Link href="/login" className="text-pink-600 hover:underline"> Back to Login </Link>
              </div>
            </div>
          )}
        </div>
